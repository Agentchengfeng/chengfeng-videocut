...
Usage:
  ...
  chengfeng-videocut job start <export> <project> [--out <file.mp4>] [--scale <n>] [--fps <n>] [--keep-work] [--api-base <url>] [--operation-id <id>]
  ...
  chengfeng-videocut project ingest <job-dir> --video <task-local-path> [--language <code>] [--aspect-ratio <W:H>] [--projects-dir <dir>] [--operation-id <id>] [--json]
  ...
  chengfeng-videocut cuts set <project> --file <file> --expected-revision <none|sha256> [--full-selection] [--api-base <url>] [--operation-id <id>] [--json]
  ...
  chengfeng-videocut export <project> [--out <file.mp4>] [--scale <n>] [--fps <n>] [--keep-work] [--dry-run] [--api-base <url>] [--operation-id <id>] [--json]
...
Write entry points return an operationId. Supplying the same --operation-id with the same input replays the recorded terminal result; supplying it with different input is rejected.

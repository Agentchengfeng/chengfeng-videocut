    ...
    <div className="hf-loader" role="status" draggable={false}>
      ...
      >
        <svg
          ...
          aria-hidden="true"
        >
          <rect x="13" y="13" width="74" height="74" rx="18" fill="#F6F5F0" />
          <rect x="13.75" y="13.75" width="72.5" height="72.5" rx="17.25" stroke="#171717" strokeWidth="1.5" />
          <path d="M50 29V71" stroke="#171717" strokeWidth="4" strokeLinecap="round" />
          <path d="M29 50H71" stroke="#171717" strokeWidth="4" strokeLinecap="round" />
          <circle cx="50" cy="50" r="7" fill="#7C5CFC" stroke="#F6F5F0" strokeWidth="3" />
        </svg>
      </div>

...
describe("useTimelineMarqueeSelection", () => {
  ...
  it("uses autoscroll position when resolving the released marquee", () => {
    ...
    // With the current 112px label gutter, one 12px autoscroll step extends
    // the selected range from 0.43s to 0.55s at 100px/s.
    const harness = renderMarqueeHarness([layer("lane-0", [element("reachable", 0.48, 0.05, 0)])]);

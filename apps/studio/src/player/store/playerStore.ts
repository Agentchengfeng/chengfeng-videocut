...
export interface TimelineElement {
  ...
  timelineRole?: string;
  /** Product-owned edit-list segment id. Presence routes timeline rendering and mutations to the EDL contract. */
  edlSegmentId?: string;
  /** Inclusive source in-point for an EDL-managed segment, in source seconds. */
  edlSourceStart?: number;
  /** Exclusive source out-point for an EDL-managed segment, in source seconds. */
  edlSourceEnd?: number;
  /**
...
interface PlayerState {
  ...
  requestedSeekOptions: { keepPlaying?: boolean } | null;
...
export const usePlayerStore = create<PlayerState>((set, get) => ({
  ...
  requestedSeekOptions: null,
  requestSeek: (time, options) => set({
    requestedSeekTime: time,
    requestedSeekOptions: options ?? null,
  }),
  clearSeekRequest: () => set({ requestedSeekTime: null, requestedSeekOptions: null }),

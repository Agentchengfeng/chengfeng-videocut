...
| 位置 | 用途与整理边界 |
|---|---|
| [hf-upstream-0.7.60](../apps/studio/src/cut/timeline/hf-upstream-0.7.60) | 只读审计母版；边界测试逐文件校验 114 项，禁止运行时代码导入 |
| [vendor/hyperframes-timeline-0.7.60](../vendor/hyperframes-timeline-0.7.60) | 早期部分快照；与上述母版重叠但含独有文件，合并前需保留来源与差异 |

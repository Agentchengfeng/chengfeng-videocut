...
本页保留早期方案，不是当前开发待办，也不表示所有步骤已完成。来源：[原始架构文档](https://github.com/Agentchengfeng/chengfeng-videocut/blob/a0d5d78d2479d0b675b5a7032179c38843cd181f/docs/architecture.md)。当前源码职责见 [架构说明](../architecture.md)。
